...
<jsp:include page="index.jsp">
    ...
    <div class='row d-flex justify-content-center'>
        <div class='col-md-8'>
            <h1 id='register'>Bad Sentences</h1>
            <form id='regForm' action='/Gradle___com_vl10new___WhaleWords_1_0_SNAPSHOT_war/badwhale' method='post' enctype='multipart/form-data'>
    <div class='form-row'>
